    ...
    KalkMainWindow::KalkMainWindow()
    {
        ...
        connect (StatussignalMapper, SIGNAL(mapped(QString)), this, SLOT(changeStatus(QString))) ;
        ...
        connect(Button14,SIGNAL(clicked()),this, SLOT(multiOperation()));
        ...
        connect(elenco, SIGNAL(itemClicked(QListWidgetItem*)), this, SLOT(selectoperand(QListWidgetItem*)));
